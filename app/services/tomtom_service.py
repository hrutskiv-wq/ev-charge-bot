...
# живого смоуку, і ще раз 31.07.2026 у бандлі квоти видачі): один
# handle_location() — це 1 виклик search_stations_near() + до
# MAX_STATIONS_TOTAL викликів get_availability() (app/handlers/user.py,
# по одному на кожну TomTom-станцію у ФІНАЛЬНІЙ видачі після злиття з
# OCM/оператором, дедупу й відбору квотою _select_by_quota;
# MAX_STATIONS_TOTAL=6 станом на зараз, з них щонайбільше стільки й може
# бути TomTom-станцій) = до 7 звернень за один пошук водія. Тобто бюджет
# 2000 — це ~285 пошуків водіїв на добу (2000 / 7), НЕ 2000. TOMTOM_SEARCH_
# LIMIT (розмір ОДНІЄЇ відповіді nearbySearch, піднятий до 10, щоб дедуп і
# квота мали з чого вибирати) на цю арифметику НЕ впливає — той самий один
# HTTP-виклик незалежно від значення.
